 ...
 */
export function underscore(str: string, allUpperCase?: boolean): string {
 ...
 */
export function humanize(str: string, lowFirstLetter?: boolean): string {
    str = str.toLowerCase();
...
/**
     ...
     */
export function foreignKey(str: string, dropIdUbar?: boolean): string {
    str = demodulize(str);
